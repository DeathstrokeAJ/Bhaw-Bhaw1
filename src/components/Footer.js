...
const Footer = () => {
  return (
    <footer className="bg-[#85716B] text-white py-8 px-6 md:px-8 font-poppins">
      <div className="max-w-7xl mx-auto my-8 flex flex-col md:flex-row justify-center text-center md:text-left">
        
        {/* Logo */}
        <div className="mb-8 mr-20 md:mb-0">
        ...
        <div className='flex flex-col md:flex-row justify-evenly'>
          ...
          <div className="mb-8 md:mb-0 w-1/3">
            ...
            <div className="flex items-center space-x-2 mb-4 text-sm">
              ...
              <div>
                <div>+91-9837366124</div>
                <div>+91-8650704147</div>
              </div>
            </div>
            ...
            <div className="border border-white w-10 h-8 rounded-lg p-2">
              ...
              <span>257 Fireweed Ln, Ketchikan, Alaska 99901, USA</span>
            </div>
          </div>
        </div>
      </div>
