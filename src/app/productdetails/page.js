...
import { CartWishlistContext } from '../../app/context/CartWishlistContext'; // Import CartWishlistContext
...
const ProductDetail = () => {
  ...
  useEffect(() => {
    const productIdFromSession = sessionStorage.getItem('productId'); // Get product ID from session storage
    ...
    const fetchProductDetails = async () => {
      const productRef = doc(db, 'products', productIdFromSession);
